...
export function PaginationFooter({ pagina, totalPaginas, totalItens, itensNaPagina, onPageChange }: Props) {
  if (totalItens === 0) return null

  return (
    <div className="flex flex-wrap items-center justify-between gap-2 px-1 text-caption-label text-muted-foreground">
      <span>
        Mostrando {itensNaPagina} de {formatarNumero(totalItens)} instâncias
      </span>
