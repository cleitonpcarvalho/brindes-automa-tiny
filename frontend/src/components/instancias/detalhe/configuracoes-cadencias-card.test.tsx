...
function cadencias(): CadenciaFornecedor[] {
  return [
    { fornecedor: "xbz", intervalo_minutos: 60, ativo: true, proxima_execucao_em: null },
    { fornecedor: "asia", intervalo_minutos: 120, ativo: false, proxima_execucao_em: null },
    { fornecedor: "somarcas", intervalo_minutos: 240, ativo: false, proxima_execucao_em: null },
    { fornecedor: "spot", intervalo_minutos: 720, ativo: true, proxima_execucao_em: null },
  ]
}
...
describe("ConfiguracoesCadenciasCard", () => {
  ...
  it("alterar o Switch de um fornecedor persiste a cadência (sem sincronizar)", () => {
    ...
    // asia começa inativo
    const switchAsia = screen.getAllByRole("switch")[1]
