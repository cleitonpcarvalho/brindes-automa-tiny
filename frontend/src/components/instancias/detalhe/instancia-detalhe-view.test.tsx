...
function instanciaDetalhe(): InstanciaDetalhe {
  return {
    ...
    fornecedores: [
      { fornecedor: "xbz", cor: "nao_configurado", ultima_execucao_em: null, ultima_execucao_status: null, produtos_total: 0, credencial_configurada: false, credencial_ativa: false },
      { fornecedor: "asia", cor: "nao_configurado", ultima_execucao_em: null, ultima_execucao_status: null, produtos_total: 0, credencial_configurada: false, credencial_ativa: false },
      { fornecedor: "somarcas", cor: "nao_configurado", ultima_execucao_em: null, ultima_execucao_status: null, produtos_total: 0, credencial_configurada: false, credencial_ativa: false },
      { fornecedor: "spot", cor: "nao_configurado", ultima_execucao_em: null, ultima_execucao_status: null, produtos_total: 0, credencial_configurada: false, credencial_ativa: false },
    ],
    cadencias: [
